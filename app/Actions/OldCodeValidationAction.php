...
//            $this->stream(to: 'req', content: $this->req);
        ...
        $checkSystemMessage = "Your task is to verify whether a set of test cases, generated from a formal model, are correctly handled in the code.
        Since execution is not possible, analyze the logic to determine whether they are likely to pass or fail.
        Format the output in Markdown, ensuring:
            ...
            3. Don't include the code or the formal model in the answer.";
