...
//        $model = \Auth::user()->settings->llm_validation;
        ...
        if($settings->startFromGeneratedCode()){
            $request = $code->requirement;
        }else{
            $request = $formalModel->requirement;
        }

        $testCaseSystem = "Given a user request, the corresponding formal model and the corresponding program source code, generate a set of test cases that the code should pass if written correctly.
...
//            $messages[] = [
//                'role' => 'user',
//                'content' => "Please check if "
//            ];
//            $message = [
//                [
//                    'role' => 'system',
//                    'content' => $systemMessageCheck,
//                ], [
//                    'role' => 'user',
//                    'content' => end($messages)['content'],
//                ]
