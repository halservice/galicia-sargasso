...
//        $this->settings = app(CodeGeneratorSettings::class);
    ...
    public function send(): void
    {
        ...
        if ($this->startFromCode) {
            ...
            $test_case_system = "Given a formal model and a code, generate a set of test cases that the code should execute if written correctly. Ensure coverage of edge cases and threshold values.
            ...
            $test_case_system = "Given a formal model, generate a set of test cases that the code should execute if written correctly. Ensure coverage of edge cases and threshold values.
            Format the output in Markdown, ensuring:
                1. No introductory phrases (e.g., 'Certainly,' 'Sure,' etc.). The response must not indicate that it is generated by an AI chatbot.
                2. Each test case is clearly separated by an empty line.";
        }
